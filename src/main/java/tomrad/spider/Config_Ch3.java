...
/**
 * Project Lynxmotion Phoenix Description: chr-3, configuration file. All
 * Hardware connections (excl controls) and body dimensions are configurated in
 * this file. Can be used with V2.0 and above Configuration version: V1.0 Date:
 * Nov 1, 2009 Programmer: Kurt (aka KurtE)
 * 
 * Hardware setup: ABB2 with ATOM 28 Pro, SSC32 V2, (See further for
 * connections)
 *
 * NEW IN V1.0 - First Release
 *
 */
@Component
public class Config_Ch3 {
	...
	public final static int cLFCoxaMin = -75; // Mepublic final static int chanipublic final static int cal limits of
												// the Left Front Leg
	...
	static final int cTravelDeadZone = 4;
}
